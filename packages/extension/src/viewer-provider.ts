...
export class ViewerProvider implements vscode.WebviewViewProvider {
  ...
  private configureWebview(webview: vscode.Webview) {
    ...
    webview.html = renderViewerHtml({
      assets: {
        viewerJs: viewerJs.toString(),
        workerJs: workerJs.toString(),
        wasmLoaderJs: wasmLoaderJs.toString(),
        wasmFile: wasmFile.toString(),
        manifoldLoaderJs: manifoldLoaderJs.toString(),
        manifoldWasmFile: manifoldWasmFile.toString(),
        mujocoLoaderJs: mujocoLoaderJs.toString(),
        mujocoWasmFile: mujocoWasmFile.toString(),
      },
